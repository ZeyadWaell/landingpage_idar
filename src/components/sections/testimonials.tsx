    ...
    <Section id="reviews">
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-[#0a0a0a] sm:text-4xl dark:text-white">
          Our users <span className="text-[#0040c1] dark:text-[#699aff]">talk about us</span>
        </h2>
        <p className="mt-4 text-lg text-[#171717]/70 dark:text-[#eff4ff]/70">
          Rated 4.8/5 based on 14K+ reviews from people taking control of their money.
        </p>
      </Reveal>
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#171717]/60 dark:text-[#eff4ff]/60">
                  {t.role}
                </p>
              </div>
            </div>
